...
test_that("correct shorthand notation for FAs", {
  ...
  expect_equal(get_fa_shorthand("FA(19:0(9-11cy3:0))", level = "structural"), "FA(19:1)")
  expect_equal(get_fa_shorthand("FA(19:0(9-11cy3:0))", level = "molecular"), "FA(19:1)")
  expect_equal(get_fa_shorthand("FA(19:0(9-11cy3:0))", level = "species"), "FA(19:1)")
  
  # cyclopropene fatty acids
  expect_equal(get_fa_shorthand("FA(19:0(9-11cy3:1(9)))", level = "structural"), "FA(19:2)")
  expect_equal(get_fa_shorthand("FA(19:0(9-11cy3:1(9)))", level = "molecular"), "FA(19:2)")
  expect_equal(get_fa_shorthand("FA(19:0(9-11cy3:1(9)))", level = "species"), "FA(19:2)")
